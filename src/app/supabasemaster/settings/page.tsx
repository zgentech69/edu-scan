...
import { saveAnnouncementAction } from '@/app/supabasemaster/actions';
...
export default function SettingsPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    const res = await saveAnnouncementAction(announcement, isActive);
    if (res.success) {
    ...
    <div className="space-y-8">
      ...
      <NeumorphicCard className="p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-xl font-display font-bold text-sand-900">Global Announcement Banner</h3>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div>
            ...
            <textarea 
              ...
              placeholder="e.g. Mid-term timetable updated for SE AIML!"
